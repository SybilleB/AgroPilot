...
const s = StyleSheet.create({
  ...
  // Step card
  stepCard: { marginHorizontal: 22, gap: 0, marginBottom: 8, backgroundColor: Colors.white, borderRadius: Layout.cardRadius, padding: 18, ...Layout.cardShadow },
  ...
  histForm: { backgroundColor: Colors.backgroundAlt, borderRadius: Layout.cardRadius, padding: 16, marginBottom: 12 },
