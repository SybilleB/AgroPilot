...
const s = StyleSheet.create({
  ...
  mapContainer: { marginHorizontal: 16, marginBottom: 14, borderRadius: 16, overflow: 'hidden', height: 420, elevation: 4 },
  ...
  dec: { backgroundColor: Colors.white, borderRadius: 14, padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', elevation: 2 },
  ...
  chartCard: { backgroundColor: Colors.white, borderRadius: 14, padding: 16, elevation: 2 },
  ...
  card: { width: '47.5%', backgroundColor: Colors.white, borderRadius: 14, padding: 14, gap: 4, elevation: 2 },
  ...
  fRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.white, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 11, gap: 10, elevation: 1 },
